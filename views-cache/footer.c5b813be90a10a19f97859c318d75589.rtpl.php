...
<div class="footer-top-area">
    ...
    <!-- jQuery sticky menu -->
    <script href="res/site/js/owl.carousel.min.js"></script>
    <script href="res/site/js/jquery.sticky.js"></script>
    
    <!-- jQuery easing -->
    <script href="res/site/js/jquery.easing.1.3.min.js"></script>
    
    <!-- Main Script -->
    <script href="res/site/js/main.js"></script>
    
    <!-- Slider -->
    <script type="text/javascript" href="res/site/js/bxslider.min.js"></script>
	<script type="text/javascript" href="res/site/js/script.slider.js"></script>
  </body>
</html>